...
class SportsAdapter extends RecyclerView.Adapter<SportsAdapter.ViewHolder>  {
    ...
    class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        void bindTo(Sport currentSport){
            ...
            Glide.with(mContext).load(currentSport.getImageResource()).into(sportImage);
        ...
        public void onClick(View view){
            ...
            ActivityOptionsCompat optionsCompat = ActivityOptionsCompat.makeSceneTransitionAnimation((Activity) mContext, sportImage, ViewCompat.getTransitionName(sportImage));
