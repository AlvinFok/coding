...
with open('../../cleaned/legislator-at-large/2020/candidate.csv', 'w', newline='', encoding="utf-8") as csvfile:
...
with open('../../cleaned/legislator-at-large/2020/by_nation.csv', 'w', newline='', encoding="utf-8") as csvfile:
    writer = csv.writer(csvfile)
...
with open('../../cleaned/legislator-at-large/2020/by_city.csv', 'w', newline='', encoding="utf-8") as csvfile:
    writer = csv.writer(csvfile)
